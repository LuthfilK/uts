...
import com.luthfil.catatanpenjualan.activity._main.MainActivity
import com.luthfil.catatanpenjualan.activity.register.RegisterActivity
...
//        startActivity<MainActivity>(BaseActivity.TAGS.USER to user)
    ...
    override fun onSuccessLogin(user: User?) {
        ...
        startActivity<MainActivity>(
            BaseActivity.TAGS.USER to user)
    }
