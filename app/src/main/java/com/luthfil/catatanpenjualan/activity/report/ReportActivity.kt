package com.luthfil.catatanpenjualan.activity.report

import android.os.Bundle
import android.util.Log.d
import com.luthfil.catatanpenjualan.R
import com.luthfil.catatanpenjualan.activity.report.adapter.ReportAdapter
import com.luthfil.catatanpenjualan.activity.report.detail.DetailReportFragment
import com.luthfil.catatanpenjualan.activity.report.presenter.ReportPresenter
import com.luthfil.catatanpenjualan.activity.report.presenter.ReportView
            ...
            ReportAdapter(
                ...
                object :
                    ...
                    override fun restore(keranjang: Keranjang?) {
                        presenter.restoreStatus(
                            user?.idUser,
                            Integer.parseInt(keranjang?.idKeranjang),
                            KeranjangStatus.PENDING.status,
                            Integer.parseInt(keranjang?.qty),
